function varieties_eval_v2(location, evalType, startDate) {
  /* input
    location: {
        parish: String,
        district: String,
...
*/
  ...
  for (i = 0; i <= num_i - 1; i++) {
    for (j = 0; j <= num_j - 1; j++) {
      ...
      } else if ((timeline_code[i][j].length = 4)) {
        output_v1[i] = {
          varieties: varieties_list[i],
          evalproduct: {
            cost: {
...
for(i=0;i<=num_i-1;i++){
  ...
  var timeline = [{}];
  for(j=0;j<=num_j-1;j++){
      if (timeline_code[i][j][2] != undefined){
          timeline[j] = 
          {
              activitiesDate: timeline_date[i][j],
              activities: [
      ...
      else if (timeline_code[i][j][1] != undefined){
          timeline[j] = 
          {
              activitiesDate: timeline_date[i][j],
              activities: [
      ...
      else if (timeline_code[i][j][0] != undefined){
          timeline[j] = 
          {
              activitiesDate: timeline_date[i][j],
              activities: [
...
function varieties_eval_v4(location, evalType, startDate) {
  /* input
  location: {
      parish: String,
      district: String,
...
//varieties_eval_v2();
module.exports.varieties_eval_v2 = varieties_eval_v2;
module.exports.varieties_eval_v3 = varieties_eval_v3;
module.exports.varieties_eval_v4 = varieties_eval_v4;